...
public class ContinueSendProcessWithError extends AbstractContinueSendProcess
{
	private final ErrorInputParameterGenerator errorInputParameterGenerator;

	public ContinueSendProcessWithError(ProcessPluginApi api, ErrorInputParameterGenerator errorInputParameterGenerator)
	{
		super(api);
	...
	protected Stream<ParameterComponent> getAdditionalInputParameters(DelegateExecution execution, Variables variables)
	{
		...
		return Stream.of(errorInputParameterGenerator.createError(errorCode, errorMessage,
				errorSource != null ? errorSource : CODESYSTEM_NUM_CODEX_DATA_TRANSFER_ERROR_SOURCE_VALUE_DTS));
	}
}
