...
import static de.netzwerk_universitaetsmedizin.codex.processes.data_transfer.ConstantsDataTransfer.CODESYSTEM_NUM_CODEX_DATA_TRANSFER_ERROR_VALUE_DOWNLOAD_OF_ENCRYPTED_VALIDATION_ERROR_FROM_DTS_FAILED;
...
public class DownloadValidationErrorFromDts extends AbstractServiceDelegate
{
	private static final Logger logger = LoggerFactory.getLogger(DownloadValidationErrorFromDts.class);

	private final String dtsIdentifierValue;

	public DownloadValidationErrorFromDts(ProcessPluginApi api, String dtsIdentifierValue)
	{
		super(api);
	...
	protected void doExecute(DelegateExecution execution, Variables variables) throws BpmnError, Exception
	{
		...
		catch (Exception e)
		{
			...
			throw new BpmnError(
					...
					"Unable to download Binary resource with encrypted validation error from DTS");
		}
	}
