...
{
	private static final Logger logger = LoggerFactory.getLogger(ContinueTranslateProcessWithError.class);
			...
			String profile, Stream<ParameterComponent> additionalInputParameters)
	{
		...
		// TODO implement continue translate with error
		logger.debug("implement continue translate with error");
