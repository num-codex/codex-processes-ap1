...
public class DeleteDataForDts extends AbstractServiceDelegate
{
	private static final Logger logger = LoggerFactory.getLogger(DeleteDataForDts.class);

	public DeleteDataForDts(ProcessPluginApi api)
	{
		super(api);
	}
