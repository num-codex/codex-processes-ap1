...
public class ActivityDefinitionProfileTest
{
	...
	public void testDataTriggerValid() throws Exception
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/num-codex-data-trigger.xml")))
		{
	...
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/num-codex-data-send.xml")))
		{
			ActivityDefinition ad = validationRule.getFhirContext().newXmlParser()
					.parseResource(ActivityDefinition.class, in);
	...
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/num-codex-data-translate.xml")))
		{
			ActivityDefinition ad = validationRule.getFhirContext().newXmlParser()
					.parseResource(ActivityDefinition.class, in);
	...
	{
		try (InputStream in = Files
				.newInputStream(Paths.get("src/main/resources/fhir/ActivityDefinition/num-codex-data-receive.xml")))
		{
			ActivityDefinition ad = validationRule.getFhirContext().newXmlParser()
					.parseResource(ActivityDefinition.class, in);
